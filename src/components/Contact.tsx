...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-2 md:py-5 bg-white dark:bg-slate-950">
      <div className="max-w-7xl mx-auto w-full px-6 md:px-12">
        ...
        >
          <h2 className="text-xs sm:text-sm font-extrabold uppercase tracking-wider text-slate-950 dark:text-slate-50 mb-2 md:mb-4 text-center md:text-left">
            Mulai Percakapan
          </h2>
        </motion.div>
