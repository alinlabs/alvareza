...
export default function Education() {
  ...
  return (
    <section id="education" className="py-2 md:py-5 bg-white dark:bg-slate-950 relative">
      <div className="max-w-7xl mx-auto w-full px-6 md:px-12">
        ...
        <div className="mb-4 md:mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b-0 md:border-b border-slate-200/60 dark:border-slate-800/60">
          ...
          {isMobile && (
            <div 
              className="flex flex-row w-full overflow-x-auto [&::-webkit-scrollbar]:hidden"
              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={`flex-1 text-center py-3 text-xs sm:text-sm font-bold transition-all duration-200 relative cursor-pointer whitespace-nowrap ${
                      isActive 
                  ...
                  >
                    ...
                    {isActive && (
                      <motion.div 
                        layoutId="activeTabUnderlineEducation"
