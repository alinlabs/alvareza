      ...
      <div className="flex-1 min-h-0 lg:h-full lg:overflow-hidden">
        ...
        {activeTab === 'img2pdf' && (
          <BerkasImg2Pdf
            ...
            img2pdfCompressionPercent={img2pdfCompressionPercent}
            setImg2pdfCompressionPercent={setImg2pdfCompressionPercent}
        ...
        {activeTab === 'merge' && (
          <BerkasMerge
            ...
            mergeCompressionPercent={mergeCompressionPercent}
            setMergeCompressionPercent={setMergeCompressionPercent}
          ...
          return (
            <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-6">
              ...
              <motion.div
                ...
                className="relative w-full max-w-3xl bg-white dark:bg-slate-950 shadow-2xl flex flex-col rounded-t-3xl sm:rounded-2xl max-h-[88vh] sm:max-h-[85vh] overflow-hidden border-t sm:border border-slate-200 dark:border-slate-800 z-10 sm:m-auto"
              >
                {/* Drag indicator for mobile bottom sheet */}
                <div className="flex sm:hidden justify-center pt-2.5 pb-1 shrink-0 bg-white dark:bg-slate-950">
