...
import { getCityFromAlamat } from '../container';
...
export default function EmailSenderPreview({ state }: PreviewProps) {
  ...
  const getFileUrl = (fileData: any) => {
    if (fileData.label === 'CV ATS') {
      return atsCvUrl || '/gambar/cv/cv-blue-2026.webp';
    }
    ...
    if (fileData.option === 'default') {
      const urlMap: Record<string, string> = {
        ...
        'Sertifikat Kompetensi Akademik': '/gambar/sertifikat/akademis1.webp',
        'Sertifikat Kompetensi Bisnis dan Digital': '/gambar/sertifikat/bisnis-digital1.webp',
        'Sertifikat Kompetensi Kepemimpinan': '/gambar/sertifikat/kepemimpinan1.webp',
        'Sertifikat Kompetensi Public Speaking': '/gambar/sertifikat/public-speaking1.webp',
        'Sertifikat Prestasi': '/gambar/sertifikat/prestasi1.webp',
    ...
    const labelKeyMap: Record<string, { option: string; file: File | null; defaultPath: string }> = {
      'CV': { option: state.cvOption, file: state.cvFile, defaultPath: '/gambar/cv/cv-blue-2026.webp' },
      'Portofolio': { option: state.portofolioOption, file: state.portofolioFile, defaultPath: '/gambar/portofolio/app-hr1.webp' },
      'Paklaring': { option: state.paklaringOption, file: state.paklaringFile, defaultPath: '/gambar/paklaring/gmg.webp' },
      'Sertifikat Kompetensi Akademik': { option: state.sertifikatKompetensiAkademikOption, file: state.sertifikatKompetensiAkademikFile, defaultPath: '/gambar/sertifikat/akademis1.webp' },
      'Sertifikat Kompetensi Bisnis dan Digital': { option: state.sertifikatKompetensiBisnisDigitalOption, file: state.sertifikatKompetensiBisnisDigitalFile, defaultPath: '/gambar/sertifikat/bisnis-digital1.webp' },
      'Sertifikat Kompetensi Kepemimpinan': { option: state.sertifikatKompetensiKepemimpinanOption, file: state.sertifikatKompetensiKepemimpinanFile, defaultPath: '/gambar/sertifikat/kepemimpinan1.webp' },
      'Sertifikat Kompetensi Public Speaking': { option: state.sertifikatKompetensiPublicSpeakingOption, file: state.sertifikatKompetensiPublicSpeakingFile, defaultPath: '/gambar/sertifikat/public-speaking1.webp' },
      'Sertifikat Prestasi': { option: state.sertifikatPrestasiOption, file: state.sertifikatPrestasiFile, defaultPath: '/gambar/sertifikat/prestasi1.webp' }
    };
        ...
        return (
          ...
          >
            ...
            >
              ...
              {/* Header */}
              <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 shrink-0 text-left">
                <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2 truncate min-w-0 pr-2">
              ...
              {/* Content Body */}
              <div className="flex-grow bg-slate-100 dark:bg-slate-950 overflow-hidden flex flex-col items-center justify-center relative sm:rounded-b-2xl">
                <div className="w-full h-full bg-white dark:bg-slate-900 overflow-hidden flex flex-col relative">
                  <PdfViewer url={previewPdf.url} urls={previewPdf.urls} zoom={pdfZoom} />
                </div>
              </div>
            </motion.div>
          </div>
