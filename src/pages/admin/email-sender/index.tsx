...
import { useEmailSenderLogic } from './container';
import { EmailSenderForm, EmailSenderPreview } from './buat-email';
import Tracker from './tracker';
import { Templates, EmailTemplates } from './templates';
...
export default function EmailSender() {
  ...
  const headerActions = (
    <div className="flex items-center gap-3 w-full justify-end">
      {/* Tabs */}
      {!isPreviewModalOpen && (
        <div className="flex items-center gap-1 p-1 bg-slate-100 dark:bg-slate-800 rounded-xl overflow-x-auto max-w-full no-scrollbar">
          <button
    ...
    <div id="admin-email-sender-page" className="space-y-6 md:space-y-6 w-full">
      ...
      <div className="md:hidden flex flex-col gap-4 pb-4 border-b border-slate-200 dark:border-slate-800 mb-6">
        <div className="text-center flex flex-col items-center">
          <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100 flex items-center justify-center gap-2.5">
