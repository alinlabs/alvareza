...
export interface EmailSenderState {
  ...
  bccEmail: string;
  setBccEmail: React.Dispatch<React.SetStateAction<string>>;
  companyName: string;
  ...
  isTemplateAuto: boolean;
  setIsTemplateAuto: React.Dispatch<React.SetStateAction<boolean>>;
  isBccDefault: boolean;
  setIsBccDefault: React.Dispatch<React.SetStateAction<boolean>>;
  isPositionGeneral: boolean;
  setIsPositionGeneral: React.Dispatch<React.SetStateAction<boolean>>;
  customSubject: string;
  ...
  portofolioSubtype: string;
  setPortofolioSubtype: React.Dispatch<React.SetStateAction<string>>;
  ...
  previewPdf: { url: string; urls?: string[]; name: string } | null;
  ...
  // PDF Optimization and Merge state/methods
  preparedPdfs: { blob: Blob; filename: string }[] | null;
  setPreparedPdfs: React.Dispatch<React.SetStateAction<{ blob: Blob; filename: string }[] | null>>;
  preparedTotalBytes: number;
  isPreparingPdf: boolean;
  preparePdfStatusMsg: string;
  preparePdfProgress: number;
  handleProcessMergePdfs: (overrideSignal?: AbortSignal) => Promise<boolean>;
  quickInput: string;
